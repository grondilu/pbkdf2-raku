...
is pbkdf2("password", :prf(&hmac-sha1), :salt("salt".encode), :c(1), :dkLen(20)),
buf8.new(<0c 60 c8 0f 96 1f 0e 71 f3 a9 b5 24 af 60 12 06 2f e0 37 a6>.map(*.parse-base(16)));

is pbkdf2("password", :prf(&hmac-sha1), :salt("salt".encode), :c(2), :dkLen(20)),
buf8.new(<ea 6c 01 4d c7 2d 6f 8c cd 1e d9 2a ce 1d 41 f0 d8 de 89 57>.map(*.parse-base(16)));

is pbkdf2("password", :prf(&hmac-sha1), :salt("salt".encode), :c(4096), :dkLen(20)),
...
is pbkdf2("pass\0word", :prf(&hmac-sha1), :salt("sa\0lt".encode), :c(4096), :dkLen(16)),
